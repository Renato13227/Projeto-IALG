...
////////////////////PREENCHER O VETOR QUE SERA USADO PARA PREENCHER O ARQUIVO BINARIO ////////////
...
{
    ofstream arquivoSbin("baselivraria.bin");
    ...
    arquivoSbin.write((char *)cadastroBIN, sizeof(livro) * tamanho);
    arquivoSbin.close();
...
void ExportarCSV(livro *cadastroBIN, int tamanho)
{
    ...
    if (arquivocsv)
    {
        ...
        arquivocsv.close();
        cout << endl
             << "Dados exportados com sucesso para o arquivo: baselivrariaexp.csv" << endl;
    }
    else
    {
...
int main()
{
    ...
    arquivoentrada.getline(cabecalho, TAM_CABECALHO, '.');
    ...
    ofstream arquivosaida("baselivraria.bin", ios::binary);
    ...
    ifstream arquivoBinario("baselivraria.bin", ios::binary);
    ...
    cout << endl << "Nossos livros estao ordenados em ordem alfabetica!" << endl << endl;
    ...
    while (continua)
    {
        ...
        case 1:
            ...
            {
                char departamentoBuscado[TAM_DEPARTAMENTO];
                cout << "Digite o departamento do livro que deseja buscar: ";
                cin.ignore();
                cin.getline(departamentoBuscado, TAM_DEPARTAMENTO);
        ...
        while (acao)
        {
            ...
            {
                preencherArquivoSaida(cadastroBIN, tamanho, continua);
